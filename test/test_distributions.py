...
class TestDistribuitons(unittest.TestCase):
    ...
    def test_uniform(self):
        ...
        for size in range(1, 10):
            ...
            for n in range(size):
                self.assertEqual(uniformvar[n], 1/size)
    ...
    def test_poisson_trunc(self):
        ...
        for n in range(0, 10):
            ...
            for k in range(n):
                self.assertEqual(poissonvar[k], expect**k/math.factorial(k)*math.exp(-expect))
    ...
    def test_poisson_stretch(self):
        ...
        for n in range(0, 10):
            ...
            for k in range(1, n+1):
                self.assertEqual(poissonvar[k]/poissonvar[0], expect**k/math.factorial((k)))
